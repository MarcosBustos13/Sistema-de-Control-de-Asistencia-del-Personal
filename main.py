...
import os
import subprocess
# Obtener la ruta del directorio actual del archivo en ejecución
...
# Ejecutar los archivos en el módulo "usuarios"
ejecutar_archivo("ingresar_usuario.py")
ejecutar_archivo("consultar_usuario.py")
ejecutar_archivo("editar_usuario.py")
ejecutar_archivo("eliminar_usuario.py")

# Ejecutar los archivos en el módulo "asistencias"
ejecutar_archivo("ingresar_he.py")
ejecutar_archivo("ingresar_hs.py")
ejecutar_archivo("consultar_asistencia.py")
ejecutar_archivo("editar_asistencia.py")
ejecutar_archivo("eliminar_asistencia.py")

# Ejecutar los archivos en el módulo "reportes"
ejecutar_archivo("reporte_individual.py")

# Ejecutar los archivos en el módulo "mantenimiento"
ejecutar_archivo("bitacora.py")
ejecutar_archivo("manual.py")
ejecutar_archivo("crear_respaldo.py")
ejecutar_archivo("restaurar.py")
